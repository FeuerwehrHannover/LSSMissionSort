  ...
  $("#sortcredits" ).click(function() {
    $( "#mission_list .missionSideBarEntry" ).each(function() {
      ...
      if(missionJSON[attr]== undefined){
        ...
        var mission_id = $(this).attr("mission_id");
        $(this).attr('data-credits', missionJSON[attr]["Credits"]);
        sortcreditsvar[index] = mission_id;
        localStorage.setItem("sort", JSON.stringify(sortcreditsvar));
      }
    });
    $( "#mission_list_alliance .missionSideBarEntry" ).each(function() {
      ...
      if(missionJSON[attr]== undefined){
        ...
        var mission_id = $(this).attr("mission_id");
        $(this).attr('data-credits', missionJSON[attr]["Credits"]);
        sortcreditsalliance[index] = mission_id;
        localStorage.setItem("sortalliance", JSON.stringify(sortcreditsalliance));
      }
    });
